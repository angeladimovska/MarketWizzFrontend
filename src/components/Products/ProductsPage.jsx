...
export const ProductsPage = () => {
    ...
    const [ products, setProducts ] = useState([
        {
            name: "Test market",
            description: "Test market bla bla",
            image: "Test market",
            marketId: "1",
        },
        {
    ...
    return (
        <>
            ...
            } } className="mb-3" onClick={ () => setModalShow(true) }>
            ...
            <ProductModal show={ modalShow } onHide={ () => setModalShow(false) } onAdd={ saveProduct }/>
            <Container>
